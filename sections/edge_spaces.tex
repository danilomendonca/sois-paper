...
%This subsection presents the main difference between
\subsection{Separation of Responsibilities}

%1: functional plasticity of nowaday's devices
%TODO: does it make sense to put in a single shot without examples?
...
Rather than defining a new organization model, we inherit from the existing works in the literature. Precisely, we adopt the definitions of.... %TODO: bring the magic!!!
